        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            ...
            <p className="text-lg md:text-2xl text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
              ...
              It reviews your codebase, finds bugs and security flaws, scans
              live API endpoints for vulnerabilities, and autonomously creates
              pull requests to fix what’s broken.{" "}
            </p>
                ...
                <div className="flex items-center justify-between mb-6 border-b border-white/5 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-4 font-mono text-xs text-slate-500">
                      KENDRA_INTEL_SHELL_v2.0
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="text-[10px] font-mono text-brand-primary/50 animate-pulse">
                      UPTIME: 99.99%
                    </div>
                  ...
                  {typedText.length >= fullText.length && (
                    ...
                    >
                      <div className="text-emerald-400 flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4" /> [SEC-SCAN]
                        AUTH_SURFACE_VULN IDENTIFIED: /api/v1/user/settings
                      </div>
                      <div className="text-yellow-400 flex items-center gap-2">
                        <Zap className="w-4 h-4" /> [INFRA]
                        DOCKER_IMAGE_OPTIMIZATION PROPOSED: -320MB BUNDLE SIZE
                      </div>
                      <div className="text-brand-primary flex items-center gap-2">
                        <GitPullRequest className="w-4 h-4" /> [AUTO-FIX]
                        PR_1240 CREATED: ADD_HMAC_VALIDATION_TO_WEBHOOKS
                      </div>
                      <div className="pt-4 text-white/40">
                        Status: MONITORING_CI_PIPELINE...
                      </div>
                    </motion.div>
                  )}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1 px-4 lg:px-0 bg-white/5 border border-white/5">
            {[
              ...
              <div
                key={idx}
                className="bg-bg-dark p-10 hover:bg-white/5 transition-colors group"
              >
                <div
                  className={`mb-6 text-${feature.color} group-hover:scale-110 transition-transform`}
                >
              ...
              {[
                {
                  ...
                  text: "Visualize and secure every public endpoint and exposed file.",
                },
                {
                  label: "VULNERABILITY PLAYBOOKS",
                  text: "Get expert advice on fixing logical flaws before they are exploited.",
                },
                {
                  label: "ZERO-TRUST PIPELINES",
                  text: "Ensure every CI/CD run meets enterprise security standards.",
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-6 group">
                  <div className="font-mono text-brand-primary/40 group-hover:text-brand-primary transition-colors">
                    0{i + 1}
                  </div>
                  <div>
                    <h4 className="text-white font-bold mb-1 tracking-widest text-xs">
                      {item.label}
                    </h4>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-brand-primary/5 border border-brand-primary/10 rounded-lg">
                    <code className="text-[10px] text-brand-primary font-mono block animate-pulse">
                      ALERT: INSECURE_AUTH_PATTERN FOUND in
                      authController.js:142
                    </code>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex items-center gap-2">
            ...
            <span className="font-black tracking-tighter text-xl text-white">
              KENDRA<span className="text-brand-primary">_SENTRY</span>
            </span>
          </div>
